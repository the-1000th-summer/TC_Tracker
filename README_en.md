...
- Windows CLI: `TC_Tracker_CLI-<version>-windows-x64.zip`
- Linux CLI: `TC_Tracker_CLI-<version>-linux-x64.tar.gz`
- macOS CLI: `TC_Tracker_CLI-<version>-macos-arm64.tar.gz`
- Windows GUI: `TC_Tracker-<version>-windows-x64.zip`
- macOS GUI: `TC_Tracker-<version>-macos-arm64.zip`
...
Extract `TC_Tracker_CLI-<version>-windows-x64.zip`, enter the extracted directory, and run:
...
```bash
tar -xzf TC_Tracker_CLI-<version>-linux-x64.tar.gz
cd TC_Tracker_CLI-<version>-linux-x64
./TC_Tracker_CLI --help
```

### macOS arm64

The macOS CLI package does not bundle Homebrew dynamic libraries. Install the required dependencies before running it:
