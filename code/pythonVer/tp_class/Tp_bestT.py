...
class Tp_bestT():
    ...
    def __init__(self, serial_No, cn_No, name, positions, intensities, max_windSpeeds, mws_10ms, mws_allLss, min_press, start_date, end_date, tp_kind, tp_maxGrade, real_PDI, mws_PDI, mws_allLs_PDI):
        ...
        ### 台风最大等级（最佳路径数据中的I最大值（不包括9变性））
        self.tp_maxGrade = tp_maxGrade
        ### 三种PDI
        self.real_PDI = real_PDI          ### float  # 10m风场算出的PDI
